...
const localeInfo = {
  'en-US': {
    messages: require('E:/workspace/ant-design-pro-master/src/locales/en-US.js').default,
    locale: 'en-US',
    antd: require('antd/lib/locale-provider/en_US'),
    data: require('react-intl/locale-data/en'),
  },
  'zh-CN': {
    messages: require('E:/workspace/ant-design-pro-master/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
